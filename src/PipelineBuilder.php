...
{
    /**
     * @var array List of Pipelines the FlowElement has been added to
     */
    public $pipelines = [];
    /**
     * @var bool
     */
    public $addJavaScriptBuilder = false;
    /**
     * @var array
     */
     ...
     * @var bool
     */
    public $useSetHeaderProperties = false;
    /**
     * @var array array of FlowElements
     */
     ...
     *  }]
     * }`
     * @param string|array $fileOrConfig file name of the file to load config, or alternatively
     *                             pass a config object already read from file
     * @return self
     */
    public function buildFromConfig($fileOrConfig): PipelineBuilder
    {
