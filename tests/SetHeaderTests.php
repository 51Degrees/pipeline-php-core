...
use fiftyone\pipeline\core\tests\Constants;
use fiftyone\pipeline\core\tests\TestPipeline;
...
class SetHeaderTests extends TestCase
{
                ...
                [
                    "device" => (object)[
                        "setheaderbrowseraccept-ch" => new AspectPropertyValue(
                            null,
                            Constants::ACCEPTCH_BROWSER_VALUE
                        )
                    ]
                ],
                ...
                [
                    "device" => (object)[
                        "setheaderplatformaccept-ch" => new AspectPropertyValue(
                            null,
                            Constants::ACCEPTCH_PLATFORM_VALUE
                        ),
                        "setheaderhardwareaccept-ch" => new AspectPropertyValue(
                            null,
                            Constants::ACCEPTCH_HARDWARE_VALUE
                        )
                    ]
                ],
    ...
    public function testSetResponseHeader_emptyHeader()
    {
        ...
        $flowData = $testPipeline->flowData;
        // FIXME: The below DOESN'T test anything
